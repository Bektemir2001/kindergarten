        ...
        <div class="container" style="margin-top: 10px;">
            <div id="addChildId">
                <form method="POST" action="{{route('admin.attendance.show')}}">
                    @csrf
                    <div class="position-relative table-responsive" style="margin-top: 20px;"><h4>Select a date to view:</h4></div>
                    <div class="row">
                        <div class="col-sm-3">
                        ...
                        <div class="col-sm-2" style="flex: 50%; padding: 15px;width: 300px;">
                            <button type="submit" class="btn btn-primary" style="margin-right:85%;">Show</button>
                        </div>
                    </div>
                </form>
            </div>
