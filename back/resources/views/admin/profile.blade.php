                    ...
                    <div class="col-lg-8 border-right">
                        <div class="p-3 py-5">
                            <div class="d-flex justify-content-between align-items-center mb-3">
                                <h4 class="text-right">Administrator's Profile</h4>
                            </div>
                            <div class="row">
                                <div class="col-md-6">
                            ...
                            <div class="row">
                                <div class="col-lg-12"><label class="labels">Mobile Number</label><input type="text" class="form-control" id="phone_number" name="phone_number" placeholder="enter phone number" value="{{$user->phone_number}}"></div>
                                <div class="col-lg-12"><label class="labels">Address</label><input type="text" class="form-control" id="address" name="address" placeholder="enter address" value="{{$user->address}}"></div>
                                <br>
                                <div class="col-lg-12">
                                    <label class="labels">Passport Front</label>
                                ...
                                <div class="col-lg-12">
                                    <hr>
                                    <label class="labels">Passport Back</label>
